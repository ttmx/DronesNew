...
public interface Tower {
     ...
     * @param a_droneRange
     * @return 0 if success, 1 if drone capacity <1, 2 if drone range <10, 3 if base
     *         doesn't exist, 4 if same name exist, 5 if drone type is invalid
     */
    int makeDrone(String a_droneName, String a_baseName, String a_droneType, int a_droneCapacity, int a_droneRange,
            Tower a_tower);
     ...
     * @param a_baseName
     * @param a_droneRange
     * @return 0 if sucess, 1 if there are no drones with fewer range, 2 if base
     *         doesn't exist
     */
